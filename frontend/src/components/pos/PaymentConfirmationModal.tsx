...
import { type PaymentMethod, type PaymentData } from "./PaymentMethodSelection";
...
export function PaymentConfirmationModal({
  ...
  const [currentStep] = useState<"payment" | "processing" | "success">(
    "payment",
  );
        ...
        {currentStep === "success" && receiptData && (
          <Card className="bg-white">
            <CardHeader className="text-center pb-4">
              ...
              <p className="text-gray-600">
                {t("pos.orderNumber", {
                  number: orderId.slice(-8).toUpperCase(),
                })}
              </p>
            </CardHeader>
                  ...
                  paymentData!.cash_tendered && (
                    <div className="text-sm text-gray-600 space-y-1">
                      <div className="flex justify-between">
                        ...
                        <span>
                          {formatCurrency(paymentData!.cash_tendered!)}
                        </span>
                      </div>
                      {paymentData!.change_amount! > 0 && (
                        <div className="flex justify-between font-medium text-green-700">
                          ...
                          <span>
                            {formatCurrency(paymentData!.change_amount!)}
                          </span>
                        </div>
                      )}
                    </div>
