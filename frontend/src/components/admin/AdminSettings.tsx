        ...
        <TabsContent value="system" className="space-y-6 mt-6">
          ...
          <Card className="border-2 border-primary/20">
            <CardHeader>
              ...
              <CardDescription>{t("common.switchLanguage")}</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="flex gap-2">
                <Button
              ...
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      updateSetting("restaurant_name", e.target.value)
                    }
                    placeholder="Steak Kenangan"
                  />
                  <p className="text-xs text-muted-foreground">
                    Nama yang ditampilkan di POS dan struk
                  </p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground">
                    {t("settings.currency", "Currency for all transactions")}
                  </p>
                </div>
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateSetting("tax_rate", e.target.value)
                      }
                    />
                    <p className="text-xs text-muted-foreground">
                      PPN Indonesia: 11%
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateSetting("service_charge", e.target.value)
                      }
                    />
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      updateSetting("tax_calculation_method", value)
                    }
                  >
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    <Label htmlFor="enable_rounding">
                      {t("settings.rounding")}
                    </Label>
                    <p className="text-xs text-muted-foreground">
                      {t("settings.rounding", "Round total to nearest value")}
                    </p>
                  </div>
                  <Switch
                    id="enable_rounding"
                    checked={
                      settings.enable_rounding === "true" ||
                      settings.enable_rounding === true
                    }
                    onCheckedChange={(checked) =>
                      updateSetting("enable_rounding", checked.toString())
                    }
                  />
                </div>
              </CardContent>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-xs text-muted-foreground">
                        {t("settings.showLogo", "Logo at top of receipt")}
                      </p>
                    </div>
                    <Switch
                      id="show_logo"
                      ...
                      onCheckedChange={(checked) =>
                        updateSetting("show_logo", checked.toString())
                      }
                    />
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-xs text-muted-foreground">
                        {t("settings.autoPrint", "Auto print customer copy")}
                      </p>
                    </div>
                    <Switch
                      id="auto_print"
                      checked={
                        settings.auto_print_customer_copy === "true" ||
                        settings.auto_print_customer_copy === true
                      }
                      onCheckedChange={(checked) =>
                        updateSetting(
                          "auto_print_customer_copy",
                          checked.toString(),
                        )
                      }
                    />
                ...
                <div className="border-t pt-4 mt-4 space-y-4">
                  <h4 className="font-medium text-sm">
                    {t("settings.printerConfig", "Konfigurasi Printer")}
                  </h4>

                  <div className="space-y-2">
                    <Label htmlFor="printer_name">
                      {t("settings.printerName", "Nama Printer")}
                    </Label>
                    <Input
                      id="printer_name"
                    ...
                    />
                    <p className="text-xs text-muted-foreground">
                      Nama printer sistem (kosongkan untuk default)
                    </p>
                  </div>

                  <div className="space-y-2">
                    <Label htmlFor="print_copies">
                      {t("settings.printCopies", "Jumlah Salinan")}
                    </Label>
                    <Select
                      value={settings.print_copies || "1"}
                      onValueChange={(value) =>
                        updateSetting("print_copies", value)
                      }
                    >
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="2">
                          2 Salinan (Pelanggan + Dapur)
                        </SelectItem>
                        <SelectItem value="3">3 Salinan</SelectItem>
                      </SelectContent>
                    </Select>
                    <p className="text-xs text-muted-foreground">
                      Jumlah salinan struk yang dicetak
                    </p>
                  </div>
                  ...
                  >
                    ...
                    {testPrinting
                      ? "Mencetak..."
                      : t("settings.testPrint", "Test Print")}
                  </Button>
                </div>
              </CardContent>
            </Card>
              ...
              <CardHeader>
                ...
                <CardDescription>
                  {t(
                    ...
                    "Configure kitchen ticket printing",
                  )}
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  <Label htmlFor="kitchen_paper_size">
                    {t("settings.paperSize")}
                  </Label>
                  <Select
                    value={settings.kitchen_paper_size || "80mm"}
                    onValueChange={(value) =>
                      updateSetting("kitchen_paper_size", value)
                    }
                  >
                  ...
                  <p className="text-xs text-muted-foreground">
                    Ukuran kertas untuk tiket dapur
                  </p>
                </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      <Label htmlFor="auto_print_kitchen">
                        {t("settings.autoPrintKitchen", "Auto Print Dapur")}
                      </Label>
                      <p className="text-xs text-muted-foreground">
                        {t(
                          "settings.autoPrintKitchen",
                          "Auto print to kitchen on new order",
                        )}
                      </p>
                    </div>
                    <Switch
                      ...
                      checked={
                        settings.auto_print_kitchen === "true" ||
                        settings.auto_print_kitchen === true
                      }
                      onCheckedChange={(checked) =>
                        updateSetting("auto_print_kitchen", checked.toString())
                      }
                    />
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      <Label htmlFor="show_prices_kitchen">
                        {t("settings.showPricesKitchen", "Tampilkan Harga")}
                      </Label>
                      <p className="text-xs text-muted-foreground">
                        {t(
                          "settings.showPricesKitchen",
                          "Show item prices on kitchen tickets",
                        )}
                      </p>
                    </div>
                    <Switch
                      ...
                      checked={
                        settings.show_prices_kitchen === "true" ||
                        settings.show_prices_kitchen === true
                      }
                      onCheckedChange={(checked) =>
                        updateSetting("show_prices_kitchen", checked.toString())
                      }
                    />
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      <Label htmlFor="kitchen_print_categories">
                        {t("settings.printByCategory", "Cetak Per Kategori")}
                      </Label>
                      <p className="text-xs text-muted-foreground">
                        {t(
                          "settings.printByCategory",
                          "Print separate tickets by category",
                        )}
                      </p>
                    </div>
                    <Switch
                      ...
                      checked={
                        settings.kitchen_print_categories === "true" ||
                        settings.kitchen_print_categories === true
                      }
                      onCheckedChange={(checked) =>
                        updateSetting(
                          "kitchen_print_categories",
                          checked.toString(),
                        )
                      }
                    />
                ...
                <div className="space-y-2">
                  <Label htmlFor="kitchen_urgent_time">
                    {t(
                      "settings.urgentOrderTime",
                      "Waktu Pesanan Mendesak (menit)",
                    )}
                  </Label>
                  <Input
                    ...
                    onChange={(e) =>
                      updateSetting("kitchen_urgent_time", e.target.value)
                    }
                  />
                  <p className="text-xs text-muted-foreground">
                    Pesanan akan ditandai mendesak setelah waktu ini
                  </p>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      updateSetting("data_retention_days", e.target.value)
                    }
                  />
                  <p className="text-xs text-muted-foreground">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      updateSetting("enable_audit_logging", checked.toString())
                    }
                  />
                </div>
              </CardContent>
