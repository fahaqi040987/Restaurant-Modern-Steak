...
import { ShoppingCart, Plus, Minus, Check, AlertCircle, ChefHat, CreditCard, ArrowRight } from 'lucide-react'
...
import type { PublicMenuItem, PublicCategory, PaymentConfirmation as PaymentConfirmationType, CreatePaymentRequest } from '@/types'
import '@/styles/public-theme.css'

// T086: Payment method type matching the component
type PaymentMethodType = 'cash' | 'qris' | 'card'
...
function CustomerOrderPage() {
    ...
    const [paymentConfirmation, setPaymentConfirmation] = useState<PaymentConfirmationType | null>(null)
                    ...
                    <Card className="mb-6 bg-[var(--public-bg-elevated)] border-[var(--public-border)]">
                        <CardContent className="pt-6">
                            <div className="flex items-center justify-between mb-4">
                                <div>
                                    <p className="text-sm text-[var(--public-text-muted)]">Nomor Pesanan</p>
                                    <p className="text-xl font-bold text-[var(--public-secondary)]">
                                        {orderInfo.order_number}
                                    </p>
                                </div>
                                <div className="text-right">
                                    <p className="text-sm text-[var(--public-text-muted)]">Meja</p>
                            ...
                            <div className="flex justify-between items-center py-3 border-t border-[var(--public-border)]">
                                <span className="text-[var(--public-text-secondary)]">Total Pembayaran</span>
